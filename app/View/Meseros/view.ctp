...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
  	...
  	<li><?php echo $this->Html->link(__('Nuevo Mesero'), array('action' => 'add')); ?></li>
    <li class="divider"></li>
		...
		<?php foreach ($mesero['Mesa'] as $mesa): ?>
			<tr>
				...
				<td class="actions">
					...
					<?php echo $this->Form->postLink(__('Eliminar'), array('controller' => 'mesas', 'action' => 'delete', $mesa['id']), array('class' => 'btn btn-sm btn-default'), __('Are you sure you want to delete # %s?', $mesa['id'])); ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</table>
...
<?php endif; ?>
	...
	<div class="actions">
		<?php echo $this->Html->link(__('Nueva Mesa'), array('controller' => 'mesas', 'action' => 'add'), array('class' => 'btn btn-sm btn-default')); ?>
	</div>
</div>